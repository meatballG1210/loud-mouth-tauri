...
${errorInfo.stack ? `\nStack Trace:\n${errorInfo.stack}` : ""}
  ...
  return (
    <div
      ...
      style={{ background: "var(--macos-grouped-bg-primary)" }}
    >
      <div
          ...
          >
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="macos-footnote font-mono">
                  {errorInfo.timestamp}
                </p>
              </div>
            ...
            <button
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.background =
                  "color-mix(in srgb, var(--macos-system-blue), black 10%)";
              }}
              onMouseLeave={(e) => {
              ...
              <a
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.color =
                    "color-mix(in srgb, var(--macos-system-blue), black 20%)";
                }}
                onMouseLeave={(e) => {

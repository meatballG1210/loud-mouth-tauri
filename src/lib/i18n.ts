...
export const translations = {
  en: {
    ...
    demoPasswordResetNotice:
      "This is a demo app. No actual emails will be sent.",
    ...
    addVocabularyFromVideos:
      "Add vocabulary from your videos to start building your collection",
    ...
    reviewDescription:
      "You have {count} words to review. Each word will be presented in context with video playback for better understanding.",
    ...
    speechError: {
      ...
      noSpeech: {
        ...
        description:
          "No speech was detected in the recording. Please speak louder and ensure your microphone is positioned correctly.",
      },
      recognitionFailed: {
        title: "Recognition Failed",
        description:
          "Speech recognition failed. Please try speaking more clearly and avoid background noise.",
      },
      repetitiveText: {
        title: "Invalid Recognition",
        description:
          "The speech recognition produced invalid results. Please try again with clearer speech.",
      },
      audioFormat: {
        title: "Audio Format Error",
        description:
          "The audio format is not supported. Please try a different browser or check your microphone settings.",
      },
      permissionDenied: {
    ...
    uploadVideoDescription:
      "Upload your video file. The system will automatically extract embedded English and Chinese subtitles if available.",
    selectVideo: "Select Video",
    uploadComplete: "Upload Complete!",
    uploadCompleteMessage:
      "Your video has been successfully uploaded and is being processed.",
    redirectingToLibrary: "Redirecting to video library...",
    uploadingProgress: "Uploading...",
    uploadProgressComplete: "complete",
    fileSelected: "File Selected",
    uploadVideoButton: "Upload Video",
    dragDropVideoHere: "Drag and drop your video file here, or click to browse",
    fileRequirementsTitle: "File Requirements",
    maxFileSize4GB: "Maximum file size: 4GB",
    supportedFormatsUpload: "Supported formats: MP4, AVI, MKV, MOV, WebM",
    subtitlesAutoExtracted:
    ...
    duplicateVideoDetected: "Duplicate Video Detected",
    duplicateVideoMessage:
      'This video has already been uploaded with the title "{title}". Please check your video library or upload a different video.',
    duplicateVideoGeneric:
      "This video has already been uploaded to your library. Please check your existing videos or upload a different file.",
    fileNotFoundTitle: "File Not Found",
    fileNotFoundMessage:
      "The selected video file could not be found. Please make sure the file exists and try again.",
    invalidInputTitle: "Invalid Input",
    invalidInputMessage:
      "The video file or title is invalid. Please check your selection and try again.",
    unexpectedError: "An unexpected error occurred while uploading the video.",
    uploadDifferentVideo: "Upload Different Video",
    viewLibrary: "View Library",
    dragDropNotSupported:
      "Please use the 'Select Video' button to choose a file. Drag and drop is not supported for security reasons.",

    // Video Player
    loadingVideo: "Loading video...",
    backToLibrary: "Back to Library",
    skipBack4s: "Skip back 4s",
    skipForward4s: "Skip forward 4s",
    speedLabel: "Speed:",
    confirmSelection: "Confirm selection",
    closePopup: "Close",
    addToVocabularyButton: "Add to Vocabulary",
    unableToFetchWordInfo:
      "Unable to fetch word information. Please check your OpenAI API key.",

    // Video Card & Grid
    playVideoAction: "Play Video",
    editInfoAction: "Edit Info",
    showInFinder: "Show in Finder",
    showInFolder: "Show in Folder",
    deleteVideoAction: "Delete Video",
    deleteVideoTitle: "Delete Video",
    deleteVideoConfirm:
      'Are you sure you want to delete "{title}"? This action cannot be undone.',
    couldNotOpenFileLocation: "Could not open file location",
    videoFilePathNotAvailable: "Video file path is not available",

    // Video Edit Modal
    editVideoInformation: "Edit Video Information",
    ...
    failedToUpdateTitle: "Failed to update video title",
    ...
    // Error Boundary
    redirectingToErrorPage: "Redirecting to error page...",
    notRedirectedAutomatically:
  ...
  zh: {
    ...
    // Vocabulary Review additional translations
    reviewDescription:
      "您有 {count} 个单词需要复习。每个单词都会在语境中呈现，并配有视频播放以便更好理解。",
    ...
    speechError: {
      ...
      audioFormat: {
        title: "音频格式错误",
        description:
          "不支持的音频格式。请尝试使用其他浏览器或检查您的麦克风设置。",
      },
      permissionDenied: {
        title: "麦克风访问被拒绝",
        description:
          "麦克风权限被拒绝。请在浏览器设置中允许麦克风访问以使用语音输入。",
      },
      general: {
        title: "语音输入错误",
    ...
    uploadVideoDescription:
      "上传您的视频文件。系统将自动提取嵌入的英文和中文字幕（如果有）。",
    selectVideo: "选择视频",
    uploadComplete: "上传完成！",
    uploadCompleteMessage: "您的视频已成功上传并正在处理中。",
    redirectingToLibrary: "正在跳转到视频库...",
    uploadingProgress: "上传中...",
    uploadProgressComplete: "完成",
    fileSelected: "文件已选择",
    uploadVideoButton: "上传视频",
    dragDropVideoHere: "将视频文件拖放到此处，或点击浏览",
    fileRequirementsTitle: "文件要求",
    maxFileSize4GB: "最大文件大小：4GB",
    supportedFormatsUpload: "支持的格式：MP4、AVI、MKV、MOV、WebM",
    subtitlesAutoExtracted: "如果存在嵌入的英文和中文字幕，将自动提取",
    thumbnailAutoGenerated: "缩略图将从视频中自动生成",
    uploadFailedTitle: "上传失败",
    duplicateVideoDetected: "检测到重复视频",
    duplicateVideoMessage:
      '此视频已以标题"{title}"上传。请检查您的视频库或上传其他视频。',
    duplicateVideoGeneric:
      "此视频已上传到您的库中。请查看现有视频或上传其他文件。",
    fileNotFoundTitle: "文件未找到",
    fileNotFoundMessage: "找不到所选视频文件。请确保文件存在，然后重试。",
    invalidInputTitle: "输入无效",
    invalidInputMessage: "视频文件或标题无效。请检查您的选择并重试。",
    unexpectedError: "上传视频时发生意外错误。",
    uploadDifferentVideo: "上传不同的视频",
    viewLibrary: "查看媒体库",
    dragDropNotSupported:
      '请使用"选择视频"按钮选择文件。出于安全原因，不支持拖放。',
    ...
    closePopup: "关闭",
    addToVocabularyButton: "添加到词汇表",
    unableToFetchWordInfo: "无法获取单词信息。请检查您的 OpenAI API 密钥。",

    // Video Card & Grid
    playVideoAction: "播放视频",
    editInfoAction: "编辑信息",
    showInFinder: "在访达中显示",
    showInFolder: "在文件夹中显示",
    deleteVideoAction: "删除视频",
    deleteVideoTitle: "删除视频",
    deleteVideoConfirm: '确定要删除"{title}"吗？此操作无法撤销。',
    couldNotOpenFileLocation: "无法打开文件位置",
    videoFilePathNotAvailable: "视频文件路径不可用",

    // Video Edit Modal
    editVideoInformation: "编辑视频信息",
    editVideoDescription: "在此处更改视频信息。完成后点击保存。",
    titleLabel: "标题",
    enterVideoTitle: "输入视频标题",
    saving: "保存中...",
    saveChanges: "保存更改",
    failedToUpdateTitle: "更新视频标题失败",

    // Empty State
    noVideosYetTitle: "尚无视频",
    noVideosYetMessage: "上传您的第一个视频以开始构建您的语言学习库。",
    uploadYourFirstVideo: "上传您的第一个视频",

    // Error Boundary
    redirectingToErrorPage: "正在跳转到错误页面...",
    notRedirectedAutomatically: "如果没有自动跳转，请刷新页面。",
